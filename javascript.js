...
function showMenu(){
  ...
  if (player.getCurrentTime() >= 496.4 && player.getCurrentTime() <= 497.4){
    player.stopVideo();
  }
  if (player.getCurrentTime() >= 548 && player.getCurrentTime() <= 549){
    player.stopVideo();
  }
  if (player.getCurrentTime() >= 646 && player.getCurrentTime() <= 647){
    player.stopVideo();
  }
}